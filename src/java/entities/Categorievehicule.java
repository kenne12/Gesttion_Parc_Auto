...
@NamedQueries({
    ...
    @NamedQuery(name = "Categorievehicule.nextId", query = "SELECT MAX(c.idCategorievehicule) FROM Categorievehicule c"),
    ...
    @NamedQuery(name = "Categorievehicule.findByNom", query = "SELECT c FROM Categorievehicule c WHERE UPPER(c.nom) = UPPER(:nom)")})
