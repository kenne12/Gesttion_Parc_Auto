...
@NamedQueries({
    ...
    @NamedQuery(name = "Typesinistre.nextId", query = "SELECT MAX(t.idTypesinistre) FROM Typesinistre t"),
    ...
    @NamedQuery(name = "Typesinistre.findByNom", query = "SELECT t FROM Typesinistre t WHERE UPPER(t.nom) = UPPER(:nom)")})
