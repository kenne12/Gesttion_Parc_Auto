...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Attribution.findAll", query = "SELECT a FROM Attribution a WHERE a.daterestitution IS NULL"),
    @NamedQuery(name = "Attribution.findAllRestitution", query = "SELECT a FROM Attribution a WHERE a.daterestitution IS NOT NULL"),
    @NamedQuery(name = "Attribution.nextId", query = "SELECT MAX(a.idAttribution) FROM Attribution a"),
...
public class Attribution implements Serializable {
    ...
    public String toString() {
        return "Attribution{" + "idAttribution=" + idAttribution + ", dateattribution=" + dateattribution + ", daterestitution=" + daterestitution + ", datesyst=" + datesyst + ", idVehicule=" + idVehicule + ", idPersonnel=" + idPersonnel + '}';
    }
