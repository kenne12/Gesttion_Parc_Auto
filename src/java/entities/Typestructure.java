...
@NamedQueries({
    ...
    @NamedQuery(name = "Typestructure.nextId", query = "SELECT MAX(t.idTypestructure) FROM Typestructure t"),
    ...
    @NamedQuery(name = "Typestructure.findByCodeFr", query = "SELECT t FROM Typestructure t WHERE UPPER(t.codeFr) = UPPER(:codeFr)"),
    @NamedQuery(name = "Typestructure.findByNomFr", query = "SELECT t FROM Typestructure t WHERE UPPER(t.nomFr) = UPPER(:nomFr)")})
