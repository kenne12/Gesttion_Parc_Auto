...
@FacesConverter(value = "sourcefinancementConverter")
public class SourcefinancementConverter implements Converter {

    @Inject
    private SourcefinancementFacadeLocal ejbFacade;
